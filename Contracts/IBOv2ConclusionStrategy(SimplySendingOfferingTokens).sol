...
contract SimpleSendingOfferingTokensIboV2Concluder is IIboV2Concluder {
    using SafeMath for uint256;
    ...
    constructor() public {
        _name = "SimpleSendingOfferingTokens";
...
contract SimpleSendingOfferingTokensIboV2ConcluderTemplate is IIboV2ConcluderTemplate {
    ...
    function createConcluder(address ibo, address raisingToken, address offeringToken, address owner, bytes memory callData) external override returns (address concluder) {
        bytes memory bytecode = type(SimpleSendingOfferingTokensIboV2Concluder).creationCode;
        ...
        SimpleSendingOfferingTokensIboV2Concluder(concluder).initialize0(ibo, raisingToken, offeringToken, owner);
